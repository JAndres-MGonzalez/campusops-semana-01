...
La línea base fue instalada y comprobada; la falla controlada del título se reprodujo y corrigió sin alterar las pruebas. El repositorio contiene la definición del problema, tres riesgos priorizados y los registros técnicos con sus logs. Consulta [las comprobaciones y el entorno](docs/estado-semana-01.md), [el diagnóstico](docs/diagnostico-semana-01.md) y [la evidencia individual](evidence/week-01/individual.json).
